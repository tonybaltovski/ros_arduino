...
long duration1, duration2, duration3, duration4, duration5, duration6, duration7, duration8, distance1, distance2, distance3, distance4, distance5, distance6, distance7, distance8; // Duration used to calculate distance

int avgNum = 10;
int iteration;
long output1, output2, output3, output4, output5, output6, output7, output8;
unsigned long pulseWait = 5000;
